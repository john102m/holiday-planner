...
const TripDetailPage: React.FC = () => {
    ...
    return (
        ...
        <div className="w-full max-w-6xl mx-auto pt-3.5 sm:pt-0 px-1 pb-2">
                    ...
                    <div>
                        ...
                        {userTrip.hideGeneralActivities && (
                            <div className="mb-3 px-3">
                                <div className="flex items-center justify-center sm:justify-start gap-2 px-3 py-2 bg-yellow-100 border border-yellow-300 text-yellow-800 rounded text-sm">

                                    <span>General destination activities hidden</span>
                                </div>
                            </div>
                        )}
