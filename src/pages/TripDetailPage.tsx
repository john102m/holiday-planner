...
const TripDetailPage: React.FC = () => {
    ...
    return (
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16">
            ...
            {/* Tabs */}
            <div className="flex overflow-x-auto gap-2 mb-4 px-2 sm:px-0">
                {tabs.map((tab) => (
                    <button
                        key={tab}
                        className={`px-2 sm:px-3 py-2 rounded-full font-semibold whitespace-nowrap transition ${activeTab === tab
